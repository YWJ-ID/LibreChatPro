...
export const tokenValues: Record<string, { prompt: number; completion: number }> = Object.assign(
  {
    ...
    'gpt-5.5': { prompt: 7.5, completion: 45 },
    ...
    'deepseek-v4': { prompt: 0.3, completion: 1.0 },
    'deepseek-v4-flash': { prompt: 0.11, completion: 0.35 },
    'deepseek-v4-pro': { prompt: 0.8, completion: 3.2 },
    ...
    'minimax-m3': { prompt: 1.0, completion: 4.0 },
    ...
    'glm-5.1': { prompt: 0.6, completion: 2.0 },
    'glm-5.2': { prompt: 0.7, completion: 2.5 },
